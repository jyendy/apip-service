# Documentación (apip-service)

Documentación **específica de este repositorio**: despliegue, OpenAPI, patrones DynamoDB.
...
El prompt consolidado en **apip-front**:

- [`prompt-backend-consolidado.md`](../../apip-front/doc/prompt-backend-consolidado.md)

Si los repos no están clonados lado a lado, abre la ruta equivalente en tu máquina.
